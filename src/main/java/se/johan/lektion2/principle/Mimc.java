package se.johan.lektion2.principle;
...
public class Mimc {
    ...
    *   Structure of code, classes, folders, functions and overall structure.
    *
    *   Question: What if we have multiple classes that make the app hard to navigate?
